                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($receipt_students as $receipt_student)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('recept-students.edit',$receipt_student->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                        ...
                                        @include('pages.students.receptStudent.delete')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
